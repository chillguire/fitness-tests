...
<body>
	...
	?>
		...
		<div class="header">
			<a href="Seleccionar-Exportar.php">
				<svg class="header-buttons" width="25px" height="25px" viewBox="0 -22 512 511" xmlns="http://www.w3.org/2000/svg">
			...
			<a href="Introducir-Valores.php">
				<svg class="header-buttons-selected" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	...
	<form id="form" action="conexion/Enviar-Valores.php" method="POST">

		<div class="formulario">

			<div class="cedula">
				<fieldset class="entrada basico">
					<legend class="texto-entrada">Cédula de identidad</legend>
					<select class="nacionalidad" name="nacionalidad">
						<option selected value="V">V</option>
						<option value="E">E</option>
					</select>
					<p class="guion">-</p>
					<input  class="ci invalid" type="text" name="ci" placeholder="Número de cédula" maxlength="8" required>
				</fieldset>
	
				<fieldset class="entrada basico">
					<legend class="texto-entrada">Nombre</legend>
					<input  name="nombre" class="campo invalid" type="text" placeholder="Nombre y apellido" maxlength="50" required>
				</fieldset>
			</div>

			<div class="sexo">
				<input type="radio" id="hombre" name="sexo" value="1" required>
				<label class="hombre invalidcheck" for="hombre">Hombre</label>
				
				<input type="radio" id="mujer" name="sexo" value="2">
				<label class="mujer invalidcheck" for="mujer">Mujer</label>
			</div>
		
			<fieldset class="entrada">
				<legend class="texto-entrada">Edad</legend>
				<input  name="edad" class="campo" type="number" placeholder="Edad en años" min="0" max="100">
			</fieldset>
		
			<fieldset class="entrada">
				<legend class="texto-entrada">Peso</legend>
				<input  name="peso" class="campo" type="number" placeholder="Peso en kilogramos" min="30" max="300" step="0.01">
			</fieldset>
		
			<fieldset class="entrada">
				<legend class="texto-entrada">Estatura</legend>
				<input  name="estatura" class="campo" type="number" placeholder="Estatura en metros" min="1.40" max="2.72" step="0.01">
			</fieldset>
			...
			<a href="Agregar-Institucion.html" class="opcion1">¿Añadir nueva institución?</a>
		</div>

		<div class="formulario">
			<fieldset class="entrada">
				<legend class="texto-entrada">1200 metros</legend>
				<input name="resistencia" class="campo" type="number" min="0" placeholder="Segundos invertidos" step="0.01">
			</fieldset>
			<fieldset class="entrada">
				<legend class="texto-entrada">Salto vertical</legend>
				<input name="salto" class="campo" type="number" min="0" placeholder="Centímetros alcanzados" step="0.1">
			</fieldset>
			<fieldset class="entrada">
				<legend class="texto-entrada">Velocidad</legend>
				<input name="velocidad" class="campo" type="number" min="0" placeholder="Segundos invertidos" step="0.01">
			</fieldset>
			<fieldset class="entrada">
				<legend class="texto-entrada">Flexibilidad</legend>
				<input name="flexibilidad" class="campo" type="number" min="0" placeholder="Centímetros alcanzados" step="0.1">
			</fieldset>
			<fieldset class="entrada">
				<legend class="texto-entrada">Abdominales</legend>
				<input name="abdominales" class="campo" type="number" min="0" placeholder="Repeticiones realizadas" step="1">
			</fieldset>

			<fieldset class="entrada flex-hombre">
				<legend class="texto-entrada flex-hombre">Flexores</legend>
				<input name="flexoresH" class="campo flex-hombre" type="number" min="0" placeholder="Repeticiones realizadas" step="1">
			</fieldset>
			
			<fieldset class="entrada flex-mujer">
				<legend class="texto-entrada flex-mujer">Flexores</legend>
				<input name="flexoresM" class="campo flex-mujer" type="number" min="0" placeholder="Segundos invertidos" step="1">
			</fieldset>
		</div>
